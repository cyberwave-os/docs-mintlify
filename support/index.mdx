...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="signal-bars"
    href="https://status.cyberwave.com"
  >
    Live uptime for the API, MQTT broker, and app. Check here first — if
    something is down, it's probably not your code.
  </Card>
  <Card
    title="Changelog"
...
<CardGroup cols={2}>
  <Card title="Robot hardware" icon="robot" href="/overview/supported-hardware">
...
<AccordionGroup>
  <Accordion title="Which robots are officially supported?">
    _Placeholder._ Current list of officially supported platforms. See [Robotic hardware](/overview/supported-hardware) for per-item setup and troubleshooting.
  </Accordion>

<Accordion title="Can I integrate a custom robot?">
  _Placeholder._ Bringing your own hardware via [custom
  hardware](/overview/connecting-hardware/custom-hardware) and [writing compatible
  drivers](/edge/drivers/writing-compatible-drivers).
</Accordion>

<Accordion title="Which cameras and sensors are supported?">
  _Placeholder._ Supported [cameras](https://cyberwave.com/cyberwave/standard-cam),
  [microphones](https://cyberwave.com/catalog/tag/microphone), and other sensors.
</Accordion>
...
<AccordionGroup>
  <Accordion title="Which SDKs are available?">
    _Placeholder._ Overview of the [Python SDK](/tools/python-sdk), [C++ SDK](/tools/cpp-sdk), [MCP server](/tools/mcp-server), and [Claude Skill](/tools/claude-skill).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What latency can I expect?">
    _Placeholder._ Typical latency and how to optimize. See [Live Teleoperation](/feature-reference/environment-editor/teleoperation).
  </Accordion>
...
1. Check [platform status](https://status.cyberwave.com) — confirm whether it's us before you debug it.
2. Search the [`cyberwave-os` GitHub org](https://github.com/cyberwave-os) for an existing issue.
3. Ask in [Discord](https://discord.gg/dfGhNrawyF) — usually the fastest path to an answer.
4. [Open a new GitHub issue](https://github.com/cyberwave-os) on the relevant repo with the details from the [filing a good issue](#filing-a-good-github-issue) checklist above.
5. For private or commercial questions, [contact us](https://cyberwave.com/contact-us) directly.
