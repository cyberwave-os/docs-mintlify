...
# mode="simulation" gives simulator-friendly defaults for state publishing
# and cw.affect(...) switches locomotion/control targets when needed
...
# For locomotion twins, send navigation commands (use the affect() target set above)
