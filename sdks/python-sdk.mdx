...
<CardGroup cols={3}>
  <Card title="Get API Token" icon="terminal" href="https://cyberwave.com/profile">
    Generate your API token from your profile page
  </Card>
  <Card title="View on PyPI" icon="download" href="https://pypi.org/project/cyberwave/">
    View the package on PyPI
  </Card>
  <Card title="Check on Github" icon="github" href="https://github.com/cyberwave-os/cyberwave-python">
