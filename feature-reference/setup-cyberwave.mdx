...
| TURN over TLS | TCP `443` | `tls.turn.cyberwave.com` | Streaming video. The relay path edge devices use, and the browser's fallback when the ports above are blocked. Note the different hostname |
