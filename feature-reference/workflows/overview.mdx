...
<CardGroup cols={2}>
  <Card title="Triggers" icon="bolt">
    Start the workflow on an event, schedule, or incoming message: manual, schedule, webhook, event, MQTT, email, camera_frame, audio_track, alert
  </Card>
...
- **Audio Track**: Run on every audio chunk from an edge microphone ([docs](/use-cyberwave/workflows/audio-track/overview))
