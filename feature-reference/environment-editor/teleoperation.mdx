...
In **Live**, select one robot with locomotion capability and semi-autonomous or fully autonomous navigation
...
Docked twins stay included in the robot's selection, and **Maps** remains available.
