...
Find it under **Maps** in the right panel while in **Editor** or **Simulate**
mode, next to **Start from stream**. Editor mode is usually where you want it —
right after laying out the site.
