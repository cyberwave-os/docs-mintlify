...
<Info>
ZIP uploads can be up to 512 MB, enough for large full-mesh assets like humanoid robots.
</Info>

### Upload from the UI

<Tip>
  For a step-by-step walkthrough of the dashboard upload wizard (Package →
  Details → Access), see [Create an Asset](/feature-reference/create-asset).
</Tip>
