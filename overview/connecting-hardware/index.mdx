...
| --- | --- | --- |
| **SO-101** | Robotic arm | [Open the SO-101 docs](/hardware/so101) |
| **Universal Robots UR7e** | Robotic arm | [Open the UR7e docs](/hardware/ur7) |
| **Enactic OpenArm** | Robotic arm | [Open the OpenArm docs](/hardware/openarm) |
| **Unitree Go2** | Robotic dog | [Open the Go2 docs](/hardware/go2) |
| **Boston Dynamics Spot** | Robotic dog | [Open the Spot docs](/hardware/spot) |
| **Waveshare UGV Beast** | Ground rover | [Open the UGV Beast docs](/hardware/ugv-beast) |
| **DJI Mini 4 Pro** | Drone | [Open the DJI Mini 4 Pro docs](/hardware/dji-mini-4-pro) |
| **DJI Mini 3 Pro** | Drone | [Open the DJI Mini 3 Pro docs](/hardware/dji-mini-3-pro) |
| **Standard Camera** | Camera | [Open the Standard Camera docs](/hardware/standard-cam) |
