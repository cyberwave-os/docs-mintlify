...
**stub:** Episodes created in an environment are visible to everyone who already has access to that environment, not just the collaborator who recorded them. Replay also shows the episode creator in both the **Manage Episodes** list and the timeline hover tooltip so teams can quickly verify who authored each slice.
