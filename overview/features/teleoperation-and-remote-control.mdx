...
The overlay lists commands from **this twin's** driver catalog. A saved controller's keys only fire for the **intersection** with that catalog — bindings for commands the twin does not declare are ignored.
