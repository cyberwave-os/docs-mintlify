...
- You need **millions of cheap rollouts** — free in simulation, impossible on real hardware.
...
<Tip>
  Each step is expanded — with reward design, the Gymnasium environment, PPO training, and sim-to-real notes — in [Train an RL policy in MuJoCo](/tutorials/train-rl-mujoco).
</Tip>
