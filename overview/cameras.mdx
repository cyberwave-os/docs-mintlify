...
Thermal cameras show a thermal-style color effect on their RGB feed in live and
simulation camera views. Colors represent image brightness, **not measured
temperature**. This display effect does not add thermal hardware integration or
thermal simulation.
