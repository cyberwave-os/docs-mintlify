...
Every catalog page bundles the **bill of materials**, supported drivers, and **troubleshooting** specific to that camera — start there whenever you're unboxing new hardware.
