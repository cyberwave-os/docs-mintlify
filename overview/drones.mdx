...
<Info>
  ...
  Cyberwave driver handles **discrete actions** (`takeoff`, `land`,
  `return_to_home`, `gimbal_rotate`, …). Continuous-stick locomotion is fully
  wired on PX4-class builds and in the simulator.
</Info>
...
<CardGroup cols={3}>
  <Card
    title="Locomotion Capability"
    icon="route"
    href="/capabilities/locomotion"
  >
