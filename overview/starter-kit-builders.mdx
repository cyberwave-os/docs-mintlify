...
graph TB
    subgraph Cloud["Cyberwave Cloud"]
        DT["Digital Twins"]
        API["API / SDK"]
        ML["ML Models & Workflows"]
    end

    Cloud -->|"MQTT / REST"| Edge
    Edge -->|"MQTT / REST"| Cloud

    subgraph Edge["Cyberwave Edge"]
        EC["Edge Core"]
        DR["Cyberwave Hardware Driver"]
    end

    Edge -->|"Serial / USB / ROS Topics"| HW
    HW -->|"Serial / USB / ROS Topics"| Edge
...
```mermaid
graph LR
    CW["Cyberwave Cloud"] ---|"MQTT/REST"| EDGE["Cyberwave Edge<br>(Edge Core + UGV Driver\non Raspberry Pi)</br>"]
    EDGE ---|"Serial UART"| ESP["ESP32\n(Motors, Sensors, Camera)"]
```
...
<CardGroup cols={2}>
  <Card title="SO101 Overview" icon="microchip" href="https://cyberwave.com/the-robot-studio/so101">
    Learn about the SO101 robot arm platform, architecture, and capabilities.
  </Card>
  <Card title="Get Started with SO101" icon="play" href="https://cyberwave.com/the-robot-studio/so101">
    Set up the SO101 robot arms and connect them to Cyberwave.
  </Card>
  <Card title="UGV Beast Overview" icon="robot" href="https://cyberwave.com/waveshare/ugv-beast">
    Learn about the UGV Beast rover platform, architecture, and capabilities.
  </Card>
  <Card title="Get Started with UGV Beast" icon="play" href="https://cyberwave.com/waveshare/ugv-beast">
