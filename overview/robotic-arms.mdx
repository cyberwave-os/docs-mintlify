...
<Steps>
  ...
  <Step title="Calibrate and assign a controller">
    Open the twin in the dashboard, run **Calibrate** (required once per arm), then **Assign Controller**: pick **Keyboard**, **Local Teleop**, **Freedrive**, an AI policy, or a custom controller.
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="microchip"
    href="https://cyberwave.com/the-robot-studio/so101"
  >
  ...
  <Card
    title="UR7e Tutorial"
    icon="robot"
    href="https://cyberwave.com/universal_robots/UR7"
  >
