...
Cyberwave supports **every major quadruped** out of the box, from the low-cost [Unitree Go2](https://cyberwave.com/unitree/go2) ([setup guide](https://cyberwave.com/unitree/go2)) and the industrial-grade [Boston Dynamics Spot](https://cyberwave.com/boston-dynamics/spot) ([setup guide](https://cyberwave.com/boston-dynamics/spot)) to everything in between. Browse the full lineup at [cyberwave.com/catalog/tag/dog](https://cyberwave.com/catalog/tag/dog).
