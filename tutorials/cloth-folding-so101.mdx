...
<Tip>
**Visualize as you go.** The repo bundles a [Rerun.io](https://www.rerun.io/) visualizer that replays joint-state graphs alongside the live video feed, making it easy to spot drifted demos before you waste training time on them. See [`scripts/visualization/`](https://github.com/apavani2/cyberwave-cloth-folding-so101/tree/main/scripts/visualization).
</Tip>
