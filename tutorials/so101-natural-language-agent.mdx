...
<Info>
**Reference implementation.** Full source for every module and smoke test referenced below lives in the [`nl_arm_controller`](https://github.com/cyberwave-os/cyberwave-python/tree/main/examples/nl_arm_controller) example in the [`cyberwave-os/cyberwave-python`](https://github.com/cyberwave-os/cyberwave-python) repo. Clone it to follow along, or use the snippets in each step as a guide for your own implementation.
</Info>
