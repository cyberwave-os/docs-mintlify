...
|----------|-------------------|
| `CYBERWAVE_API_KEY` | **\<to be filled\>**<br/>Your unique API authentication token. Get this from the Cyberwave Dashboard under Settings > API Keys. |
...
CYBERWAVE_API_KEY=<TO_BE_FILLED>
...
<AccordionGroup>
  <Accordion title="Edge device won't connect">
    **Solution:**
    - Verify your `CYBERWAVE_API_KEY` is correct
