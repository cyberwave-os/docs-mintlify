---
title: "Building Edge-to-Cloud VLM Pipelines"
sidebarTitle: "Edge VLM Pipeline"
description: "Develop an intelligent VLM pipeline for real-time visual inspection and automated safety monitoring."
icon: "code"
iconType: "solid"
---

<Info>
**Duration:** 25-30 minutes | **Stack:** Python, VLM, Edge Devices, Workflows
</Info>

## Overview

In this tutorial, you will learn how to connect your physical hardware to Cyberwave and build an automated AI safety sentinel using Vision Language Models. 
...
We utilize the `cyberwave-edge-python` SDK to handle the hardware abstraction layer (HAL) and the network handshake between your physical camera and Cyberwave.
...
- **Output Used:** We will utilize the `Image URL` output generated by this node
...
- **Image URL [Reference Node]:** Select the `Data Source` node and map its `Image URL` output to this field
- **Output Used:** We will use the `Result` variable (string format)
