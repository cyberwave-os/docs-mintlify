---
title: "Build a sandwich-making robot"
sidebarTitle: "Sandwich-Making Robot"
...
Before calibrating, you need a Cyberwave environment with the SO-101 arm and camera twins added and paired to the hardware. The full reference is in [SO-101 Get Started: Set Up the Cyberwave Environment](https://cyberwave.com/the-robot-studio/so101#step-1-set-up-the-cyberwave-environment).

1. In the Cyberwave dashboard, click **New Environment** and give it a name (e.g. _"Sandwich Bot"_).
...
_Built by Siddharth Mehta as part of the Cyberwave Builder Program._
