...
Cyberwave connects to **80+ robotic devices** out of the box through its [hardware catalog](https://cyberwave.com/catalog). Every device in the catalog has a pre-built driver that is automatically installed when you pair hardware with a digital twin, with no manual integration required.
