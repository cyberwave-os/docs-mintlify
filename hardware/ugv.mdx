...
**SSH Troubleshooting**: In case you're unable to enable SSH with the guide instructions, [refer to this miscellaneous way to establish a SSH connection](ugv#miscellaneous) with the UGV Beast Rover. 
...
Start the full UGV Beast ROS 2 stack with the MQTT bridge:

<Tabs>
  <Tab title="Using the run script">
  ...
  <Tab title="Direct launch (Development)">
