...
<Note>
In Live mode, slight delay between physical arm motion, digital twin motion, and camera stream is expected. See [Live Teleoperation Latency](/use-cyberwave/teleoperation-latency) for details.
</Note>
