...
For the authoritative `.proto` definitions (including MQTT **topic patterns** repeated in every file header alongside field-level comments), see also [Protobuf schemas](/api-reference/protobuf/cyberwave-schemas).
