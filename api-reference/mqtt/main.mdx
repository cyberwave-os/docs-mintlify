...
<Note>
  The current payload uses Cartesian coordinates. The proposed extension for
  supporting both Cartesian and GPS-native vehicles is documented in
  [Navigation Coordinate Convention](/feature-reference/edge/drivers/navigation-coordinate-convention).
</Note>
