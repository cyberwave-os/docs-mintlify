...
------------- | ------------- | -------------
[**src_app_api_catalog_seed_seed_catalog**](#src_app_api_catalog_seed_seed_catalog) | **POST** /api/v1/catalog/seed | Seed Catalog
[**src_app_api_catalog_seed_seed_options**](#src_app_api_catalog_seed_seed_options) | **GET** /api/v1/catalog/seed-options | Seed Options
...
------------- | ------------- | ------------- | -------------
 **catalog_seed_request_schema** | [**CatalogSeedRequestSchema**](/api-reference/rest/CatalogSeedRequestSchema)|  | 
