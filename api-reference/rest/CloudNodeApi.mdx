...
[**src_app_api_cloud_nodes_get_instance_metadata**](CloudNodeApi.md#src_app_api_cloud_nodes_get_instance_metadata) | **GET** /api/v1/cloud-node/instances/{instance_uuid}/metadata | Get Instance Metadata
...
[**src_app_api_cloud_nodes_mark_instance_failed**](CloudNodeApi.md#src_app_api_cloud_nodes_mark_instance_failed) | **POST** /api/v1/cloud-node/{uuid}/failed | Mark Instance Failed
[**src_app_api_cloud_nodes_mark_instance_terminated**](CloudNodeApi.md#src_app_api_cloud_nodes_mark_instance_terminated) | **POST** /api/v1/cloud-node/{uuid}/terminated | Mark Instance Terminated
...
[**src_app_api_cloud_nodes_save_cloud_node_instance_log**](CloudNodeApi.md#src_app_api_cloud_nodes_save_cloud_node_instance_log) | **POST** /api/v1/cloud-node/{uuid}/log | Save Cloud Node Instance Log
