...
[**src_app_api_edge_nodes_restart_edge_core**](DefaultApi.md#src_app_api_edge_nodes_restart_edge_core) | **POST** /api/v1/edges/{uuid}/restart-core | Restart Edge Core
...
[**src_app_api_environments_add_environment_waypoints**](DefaultApi.md#src_app_api_environments_add_environment_waypoints) | **POST** /api/v1/environments/{uuid}/waypoints | Add Environment Waypoints
...
[**src_app_api_environments_delete_environment**](DefaultApi.md#src_app_api_environments_delete_environment) | **DELETE** /api/v1/environments/{uuid} | Delete Environment
...
[**src_app_api_environments_delete_environment_waypoint**](DefaultApi.md#src_app_api_environments_delete_environment_waypoint) | **DELETE** /api/v1/environments/{uuid}/waypoints/{waypoint_id} | Delete Environment Waypoint
...
[**src_app_api_environments_get_environment_waypoints**](DefaultApi.md#src_app_api_environments_get_environment_waypoints) | **GET** /api/v1/environments/{uuid}/waypoints | Get Environment Waypoints
...
[**src_app_api_environments_import_environment_mujoco_scene**](DefaultApi.md#src_app_api_environments_import_environment_mujoco_scene) | **POST** /api/v1/environments/{uuid}/import/mujoco-scene | Import Environment Mujoco Scene
[**src_app_api_environments_import_environment_universal_schema**](DefaultApi.md#src_app_api_environments_import_environment_universal_schema) | **POST** /api/v1/environments/{uuid}/import/universal-schema | Import Environment Universal Schema
[**src_app_api_environments_import_environment_urdf**](DefaultApi.md#src_app_api_environments_import_environment_urdf) | **POST** /api/v1/environments/{uuid}/import/urdf | Import Environment Urdf
...
[**src_app_api_labs_admin_force_end_session**](DefaultApi.md#src_app_api_labs_admin_force_end_session) | **DELETE** /api/v1/labs/milan-so101/admin/sessions/{session_uuid} | Admin Force End Session
...
[**src_app_api_labs_get_admin_lab_overview**](DefaultApi.md#src_app_api_labs_get_admin_lab_overview) | **GET** /api/v1/labs/milan-so101/admin/sessions | Get Admin Lab Overview
...
[**src_app_api_maps_finalize_stream_map**](DefaultApi.md#src_app_api_maps_finalize_stream_map) | **POST** /api/v1/maps/{uuid}/stream-finalize | Finalize Stream Map
...
[**src_app_api_maps_stop_map_from_stream**](DefaultApi.md#src_app_api_maps_stop_map_from_stream) | **POST** /api/v1/maps/stream-stop | Stop Map From Stream
...
[**src_users_api_organizations_list_organization_workspaces**](DefaultApi.md#src_users_api_organizations_list_organization_workspaces) | **GET** /api/v1/users/organizations/{uuid}/workspaces | List Organization Workspaces
...
twins that contain this edge fingerprint in Twin.metadata["edge_fingerprint"].
...
[**EdgeCoreRestartResponseSchema**](EdgeCoreRestartResponseSchema.md)
...
DEPRECATED: camera configs now live in Twin.metadata["edge_configs"] and
...
------------- | ------------- | ------------- | -------------
 **uuid** | **str**|  | 
 **environment_waypoint_bulk_create_schema** | [**EnvironmentWaypointBulkCreateSchema**](EnvironmentWaypointBulkCreateSchema.md)|  | 

### Return type

[**EnvironmentWaypointSchema[]**](EnvironmentWaypointSchema.md)
...
Query param: replace_existing (bool, default false)
...
via asset_uuid or asset_registry_id so the twin can be linked correctly.

Multipart form field: file (.urdf)
Query params:
  asset_uuid / asset_registry_id - required: identifies the Cyberwave Asset
  position_x/y/z - world position for the spawned twin (default 0,0,0)
  rotation_x/y/z/w - world orientation quaternion (default identity)
  replace_existing - if true, delete existing twins first
 ...
 **replace_existing** | **bool**|  | [optional] [default to False]
 **asset_uuid** | **str**|  | [optional] 
 **asset_registry_id** | **str**|  | [optional] 
...
[**AdminLabOverviewSchema**](AdminLabOverviewSchema.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **map_stream_stop_schema** | [**MapStreamStopSchema**](MapStreamStopSchema.md)|  | 
