...
------------- | ------------- | -------------
[**src_users_api_profile_change_password**](ProfileApi.md#src_users_api_profile_change_password) | **PUT** /api/v1/users/@me/password/ | Change Password
[**src_users_api_profile_complete_onboarding**](ProfileApi.md#src_users_api_profile_complete_onboarding) | **POST** /api/v1/users/@me/onboarding/complete/ | Complete Onboarding
...
------------- | ------------- | ------------- | -------------
 **password_change_schema** | [**PasswordChangeSchema**](PasswordChangeSchema.md)|  | 
...
[**OnboardingCompletionSchema**](OnboardingCompletionSchema.md)
