...
All REST endpoints require an API key. Go to the [Cyberwave dashboard](https://cyberwave.com/profile) → **API Tokens** card → **Create Token**, then pass the key in the `Authorization` header on every request.
...
| Where to get a key | [`https://cyberwave.com/profile`](https://cyberwave.com/profile) → **API Tokens** card → **Create Token** |
